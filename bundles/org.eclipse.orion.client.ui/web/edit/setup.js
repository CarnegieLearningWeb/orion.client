...
define([
	...
	EventTarget, URITemplate, i18nUtil, PageUtil, util, objects, lib, Deferred, mProjectClient, mSplitter, mTooltip, mHTMLEditor, mJSEditor, mContextMenu, mMenuBar, bidiUtils, mCustomGlobalCommands, mGeneralPrefs, mBreadcrumbs, mKeyBinding, urlModifier,
...
objects.mixin(EditorSetup.prototype, {
	...
	setSplitterMode: function(mode, href) {
		...
		var splitEditorViewerNode, splitterNode, rightCodePane;
		if (this.editorViewers. length > 1) {
			...
			//show right pane
			rightCodePane = splitEditorViewerNode.childNodes[1];
			rightCodePane.style.display = "block";
		}
